...
use Rebeca\TaskBundle\Form\StatusType;
...
class StatusController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TaskBundle:Status')->findAll();
     ...
     * @Method("POST")
     * @Template("TaskBundle:Status:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TaskBundle:Status')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TaskBundle:Status:edit.html.twig")
     */
